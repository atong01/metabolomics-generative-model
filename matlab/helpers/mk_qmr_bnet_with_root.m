function bnet = mk_qmr_bnet_with_root(G, inhibit, leak, prior, tabular_findings, onodes)
...
N = 1 + Ndiseases + Nfindings;
finding_node = Ndiseases+2:N;
ns = 2*ones(1,N);
dag = zeros(N,N);
dag(2:Ndiseases + 1, finding_node) = G;
